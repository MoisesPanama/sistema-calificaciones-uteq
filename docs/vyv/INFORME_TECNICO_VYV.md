...
   
Cada historia incluye criterios de aceptación (1–5); por ejemplo HU-03 exige rango 0–10, guardado masivo, upsert auditado y bloqueo de materias no asignadas.   
...
**9. Encuesta de satisfacción**  
Diseñada en Google Forms (exportable a PDF), **20 preguntas en 3 bloques**: 14 de escala Likert 1–5 (aceptación), 4 Sí/No y 2 abiertas (solo las necesarias para capturar sugerencias). Aplicada a **30 usuarios** (los 6 participantes de la prueba Beta y 24 usuarios adicionales de los módulos involucrados). Detalle: docs/vyv/08_encuesta_satisfaccion.md.  
...
   
**Complemento Sí/No (P15–P18):** 112 de 120 respuestas favorables (93%); ningún participante reportó errores bloqueantes (P16 100% "No").  
**Interpretación:** satisfacción global alta (94%). La confiabilidad, la precisión y la seguridad son los puntos más fuertes (5.0). Las oportunidades de mejora se concentran en la apariencia (4.2), los mensajes de error (4.2) y en sugerencias de usabilidad móvil y exportación de planillas.  
