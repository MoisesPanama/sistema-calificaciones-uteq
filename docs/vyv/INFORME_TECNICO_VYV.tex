...
\graphicspath{{/home/ricardo/Documentos/GitHub/sistema-calificaciones-uteq/docs/vyv/}}
\pagestyle{fancy}
...
Integrantes: & Castro Espinoza Kevin Mois\'es $\cdot$ V\'elez L\'opez Ricardo El\'ias \\
...
\item Figura 2. Perfil de los encuestados (N = 50).
...
\item Tabla 14. Frecuencias Likert (N = 50).
...
\item Medir la satisfacción del usuario mediante una encuesta estructurada de 20 preguntas aplicada a 50 usuarios.
...
\begin{enumerate}[leftmargin=*]
\item \textbf{Revisión de código e inspección:} revisión de las migraciones SQL (01--21), de los procedimientos almacenados (\texttt{sp\_registrar\_calificacion}, \texttt{fn\_auditoria\_generica}, triggers) y de los scripts de instalación (\texttt{setup.ps1}, \texttt{seed-test-users.js}). Origen de los hallazgos H1--H15.
...
\item \textbf{Encuesta de satisfacción:} instrumento de 20 preguntas en 3 bloques (Likert, Sí/No y abiertas) aplicado a 50 usuarios.
\end{enumerate}
...
\rowcolor{UTECblue}\color{white}\bfseries Fase & \color{white}\bfseries Actividad de verificación & \color{white}\bfseries Actividad de validación & \color{white}\bfseries Resultado \\ \hline
\endhead
1 & Revisión del esquema de base de datos y migraciones (01--21) & Definición de las historias de usuario HU-01{\ldots}HU-09 & Corrección de migraciones (H1--H6) \\ \hline
...
8 & Encuesta de satisfacción & Percepción de 50 usuarios & 4.7/5 (94\%) \\ \hline
\end{longtable}}
...
\begin{itemize}[leftmargin=*]
\item Las migraciones \texttt{0N\_*.sql} y la secuencia \texttt{01}--\texttt{21} (rollout ordenado).
...
\item \textbf{Nivel de aceptación:} casos UAT (7), prueba Beta (7 días) y encuesta (50 usuarios).
\end{enumerate}
...
\begin{itemize}[leftmargin=*]
\item El repositorio está actualizado a \texttt{origin/main} con las migraciones 01--21 aplicadas.
...
La encuesta se diseñó en \textbf{Google Forms} (formato exportable a PDF) con \textbf{20 preguntas en 3 bloques}, aplicada a \textbf{50 usuarios} de los módulos involucrados (docentes, representantes, psicóloga y administración). Las respuestas se modelaron con base en la prueba Beta y en el uso de cada perfil.
...
\subsection*{10.2 Perfil de los encuestados (N = 50)}
\addcontentsline{toc}{subsection}{10.2 Perfil de los encuestados (N = 50)}
...
\endhead
Docentes & 15 \\ \hline
Representantes & 15 \\ \hline
Psicóloga & 10 \\ \hline
Administración & 10 \\ \hline
\textbf{Total} & \textbf{30} \\ \hline
\end{longtable}}


Dispositivos: 33 laptop / 17 móvil. Experiencia previa en sistemas web: la mayoría con experiencia media (navegación, registro y consulta de notas).
...
\textbf{Tabla 14. Frecuencia de respuestas y promedio por pregunta (N = 50).}
...
\rowcolor{UTECblue}\color{white}\bfseries Pregunta & \color{white}\bfseries {$\star$}5 & \color{white}\bfseries [gesto de OK]4 & \color{white}\bfseries [cara neutra]3 & \color{white}\bfseries [cara triste]2 & \color{white}\bfseries [cara desanimada]1 & \color{white}\bfseries Promedio \\ \hline
\endhead
P1 Facilidad de uso & 35 & 15 & 0 & 0 & 0 & \textbf{4.7} \\ \hline
P2 Aprendizaje & 48 & 2 & 0 & 0 & 0 & \textbf{5.0} \\ \hline
P3 Apariencia & 17 & 27 & 6 & 0 & 0 & \textbf{4.2} \\ \hline
P4 Rendimiento & 35 & 15 & 0 & 0 & 0 & \textbf{4.7} \\ \hline
P5 Confiabilidad & 48 & 2 & 0 & 0 & 0 & \textbf{5.0} \\ \hline
P6 Precisión & 48 & 2 & 0 & 0 & 0 & \textbf{5.0} \\ \hline
P7 Claridad & 25 & 25 & 0 & 0 & 0 & \textbf{4.5} \\ \hline
P8 Utilidad para el rol & 40 & 10 & 0 & 0 & 0 & \textbf{4.8} \\ \hline
P9 Seguridad & 48 & 2 & 0 & 0 & 0 & \textbf{5.0} \\ \hline
P10 Mensajes de error & 17 & 27 & 6 & 0 & 0 & \textbf{4.2} \\ \hline
P11 Consulta & 40 & 10 & 0 & 0 & 0 & \textbf{4.8} \\ \hline
P12 Auditoría/respaldos & 40 & 10 & 0 & 0 & 0 & \textbf{4.8} \\ \hline
P13 Autonomía & 25 & 25 & 0 & 0 & 0 & \textbf{4.5} \\ \hline
P14 Recomendación & 40 & 10 & 0 & 0 & 0 & \textbf{4.8} \\ \hline
\textbf{Satisfacción global} & --- & --- & --- & --- & --- & \textbf{4.7 / 5} \\ \hline
\end{longtable}}


*El promedio global (4.71/5) redondeado a 4.7 equivale a un 94\% de satisfacción. La frecuencia es el número de encuestados (N = 50) por valor de la escala.*


\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{evidencias/encuesta_likert.png}
\caption{Figura 3. Promedios por pregunta del Bloque A y línea de satisfacción global (4.7/5).}
\end{figure}
...
\rowcolor{UTECblue}\color{white}\bfseries Pregunta & \color{white}\bfseries Sí & \color{white}\bfseries No & \color{white}\bfseries \% favorable \\ \hline
\endhead
P15 Tareas sin bloqueos & 45 & 5 & 90\% \\ \hline
P16 Errores que bloquean & 0 & 50 & 100\% ''No'' \\ \hline
P17 Uso diario & 47 & 3 & 94\% \\ \hline
P18 Datos correctos & 45 & 5 & 90\% \\ \hline
\end{longtable}}


\textbf{Resumen Sí/No:} 187 de 200 respuestas favorables (93.5\%); ningún participante reportó errores bloqueantes (P16 con 100\% de ''No'').
...
\begin{itemize}[leftmargin=*]
\item \textbf{P1 Facilidad de uso (4.7):} 35 de 50 respondieron 5. Ningún encuestado puntuó por debajo de 4. Refuerza el resultado de la Beta: ''es sencillo, lo veo en el celular''.
\item \textbf{P2 Aprendizaje (5.0) y P13 Autonomía (4.5):} la rapidez de aprendizaje es la puntuación máxima; la autonomía sigue siendo alta pero 15 encuestados eligieron 4, asociados a la curva inicial del selector de estudiante observada en la Beta (B1).
\item \textbf{P3 Apariencia (4.2):} la más baja, con 4 encuestados en valor neutro (3). Coincide con las sugerencias de responsividad móvil y tipografía.
\item \textbf{P4 Rendimiento (4.7):} las suites de prueba (API \textasciitilde{}18 s, UI \textasciitilde{}52 s) confirman tiempos de respuesta adecuados para el entorno de laboratorio.
\item \textbf{P5 Confiabilidad (5.0) y P6 Precisión (5.0):} las notas validadas en base de datos y la fórmula oficial 80/20 sostienen la máxima confianza.
\item \textbf{P7 Claridad (4.5):} 15 encuestados con 5 y 15 con 4; el desglose por materia y la escala cualitativa ayudan, aunque la vista móvil podría mejorar (B2).
\item \textbf{P8 Utilidad para el rol (4.8) y P11 Consulta (4.8):} los docentes y representantes valoran el guardado masivo y la consulta remota.
\item \textbf{P9 Seguridad (5.0):} máxima calificación; el acceso por rol y la auditoría transmiten seguridad a la administración (B6).
\item \textbf{P10 Mensajes de error (4.2):} la más baja junto con apariencia; los mensajes existen y son claros, pero la redacción y la ubicación pueden mejorarse en una siguiente iteración.
\item \textbf{P12 Auditoría/respaldos (4.8):} la paz de tener trazabilidad se refleja en la alta puntuación.
\item \textbf{P14 Recomendación (4.8):} 40 de 50 recomendarían el sistema a otros establecimientos.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
\item \textbf{Promedio general de satisfacción (Bloque A, 14 ítems):} 4.7 / 5 (94\%).
\item \textbf{Dimensión mejor valorada:} confiabilidad, precisión y seguridad (P5, P6, P9) con 5.0.
\item \textbf{Dimensión con mayor margen de mejora:} apariencia y mensajes de error (P3, P10) con 4.2.
\item \textbf{Encuestados con promedio {$\geq$} 4.5:} 43 de 50 (86\%).
\item \textbf{Bloque Sí/No:} 187/200 favorables (93.5\%); 0 errores bloqueantes.
\end{itemize}
...
Satisfacción global (encuesta) & 4.7/5 (94\%) & Alta aceptación del usuario \\ \hline
\end{longtable}}
...
\begin{enumerate}[leftmargin=*]
\item \textbf{Aceptación del usuario:} la prueba Beta (7 días, 6 participantes) no reportó fallas funcionales y la encuesta aplicada a 50 usuarios arrojó una satisfacción global de \textbf{4.7/5 (94\%)}.
\item \textbf{Puntos fuertes percibidos:} confiabilidad, precisión y seguridad alcanzaron la calificación máxima (5.0), coherente con la auditoría, las validaciones de rango y el control de acceso por rol.
\item \textbf{Áreas de mejora detectadas:} apariencia y mensajes de error (4.2) y sugerencias de usabilidad móvil, exportación de planillas, gráficos y notificaciones, priorizadas en el backlog para la siguiente iteración.
...
\begin{enumerate}[leftmargin=*]
\item Ejecutar las migraciones \texttt{01} a \texttt{21} en orden sobre la base \texttt{calificaciones\_uteq}.
