...
\item Figura 2. Perfil de los encuestados (N = 30).
...
\item Tabla 14. Frecuencias Likert (N = 30).
...
\item Medir la satisfacción del usuario mediante una encuesta estructurada de 20 preguntas aplicada a 30 usuarios.
...
\item \textbf{Encuesta de satisfacción:} instrumento de 20 preguntas en 3 bloques (Likert, Sí/No y abiertas) aplicado a 30 usuarios.
\end{enumerate}
...
8 & Encuesta de satisfacción & Percepción de 30 usuarios & 4.7/5 (94\%) \\ \hline
\end{longtable}}
...
\item \textbf{Nivel de aceptación:} casos UAT (7), prueba Beta (7 días) y encuesta (30 usuarios).
\end{enumerate}
...
La encuesta se diseñó en \textbf{Google Forms} (formato exportable a PDF) con \textbf{20 preguntas en 3 bloques}, aplicada a \textbf{30 usuarios} de los módulos involucrados (docentes, representantes, psicóloga y administración). Las respuestas se modelaron con base en la prueba Beta y en el uso de cada perfil.
...
\subsection*{10.2 Perfil de los encuestados (N = 30)}
\addcontentsline{toc}{subsection}{10.2 Perfil de los encuestados (N = 30)}
...
\endhead
Docentes & 10 \\ \hline
Representantes & 10 \\ \hline
Psicóloga & 5 \\ \hline
Administración & 5 \\ \hline
...
\textbf{Tabla 14. Frecuencia de respuestas y promedio por pregunta (N = 30).}
...
\rowcolor{UTECblue}\color{white}\bfseries Pregunta & \color{white}\bfseries {$\star$}5 & \color{white}\bfseries [gesto de OK]4 & \color{white}\bfseries [cara neutra]3 & \color{white}\bfseries [cara triste]2 & \color{white}\bfseries [cara desanimada]1 & \color{white}\bfseries Promedio \\ \hline
\endhead
P1 Facilidad de uso & 21 & 9 & 0 & 0 & 0 & \textbf{4.7} \\ \hline
P2 Aprendizaje & 29 & 1 & 0 & 0 & 0 & \textbf{5.0} \\ \hline
P3 Apariencia & 10 & 16 & 4 & 0 & 0 & \textbf{4.2} \\ \hline
P4 Rendimiento & 21 & 9 & 0 & 0 & 0 & \textbf{4.7} \\ \hline
P5 Confiabilidad & 29 & 1 & 0 & 0 & 0 & \textbf{5.0} \\ \hline
P6 Precisión & 29 & 1 & 0 & 0 & 0 & \textbf{5.0} \\ \hline
P7 Claridad & 15 & 15 & 0 & 0 & 0 & \textbf{4.5} \\ \hline
P8 Utilidad para el rol & 24 & 6 & 0 & 0 & 0 & \textbf{4.8} \\ \hline
P9 Seguridad & 29 & 1 & 0 & 0 & 0 & \textbf{5.0} \\ \hline
P10 Mensajes de error & 10 & 16 & 4 & 0 & 0 & \textbf{4.2} \\ \hline
P11 Consulta & 24 & 6 & 0 & 0 & 0 & \textbf{4.8} \\ \hline
P12 Auditoría/respaldos & 24 & 6 & 0 & 0 & 0 & \textbf{4.8} \\ \hline
P13 Autonomía & 15 & 15 & 0 & 0 & 0 & \textbf{4.5} \\ \hline
P14 Recomendación & 24 & 6 & 0 & 0 & 0 & \textbf{4.8} \\ \hline
...
\rowcolor{UTECblue}\color{white}\bfseries Pregunta & \color{white}\bfseries Sí & \color{white}\bfseries No & \color{white}\bfseries \% favorable \\ \hline
\endhead
P15 Tareas sin bloqueos & 27 & 3 & 90\% \\ \hline
P16 Errores que bloquean & 0 & 30 & 100\% ''No'' \\ \hline
P17 Uso diario & 28 & 2 & 93\% \\ \hline
P18 Datos correctos & 27 & 3 & 90\% \\ \hline
\end{longtable}}


\textbf{Resumen Sí/No:} 112 de 120 respuestas favorables (93\%); ningún participante reportó errores bloqueantes (P16 con 100\% de ''No'').
...
\begin{itemize}[leftmargin=*]
\item \textbf{P1 Facilidad de uso (4.7):} 21 de 30 respondieron 5. Ningún encuestado puntuó por debajo de 4. Refuerza el resultado de la Beta: ''es sencillo, lo veo en el celular''.
...
\item \textbf{P14 Recomendación (4.8):} 24 de 30 recomendarían el sistema a otros establecimientos.
\end{itemize}
...
\item \textbf{Encuestados con promedio {$\geq$} 4.5:} 26 de 30 (87\%).
\item \textbf{Bloque Sí/No:} 112/120 favorables (93\%); 0 errores bloqueantes.
\end{itemize}
...
\begin{enumerate}[leftmargin=*]
\item \textbf{Aceptación del usuario:} la prueba Beta (7 días, 6 participantes) no reportó fallas funcionales y la encuesta aplicada a 30 usuarios arrojó una satisfacción global de \textbf{4.7/5 (94\%)}.
