...
await page.locator('#nombre1').fill('PWEst');
  ...
  await page.locator('#apellido1').fill(tag);
  await page.locator('#apellido2').fill('PW');
...
await page.locator('#rep-nombre1').fill('PWRep');
  ...
  await page.locator('#rep-apellido1').fill(tag);
  await page.locator('#rep-apellido2').fill('PW');
