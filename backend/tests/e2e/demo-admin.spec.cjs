...
test('1. admin crea un estudiante desde cero', async ({ page }) => {
  ...
  await page.locator('#apellido1').fill('Alumno' + tag);
  await page.locator('#apellido2').fill('Demo');
  ...
  await page.locator('#rep-apellido1').fill('Padre' + tag);
  await page.locator('#rep-apellido2').fill('Demo');
