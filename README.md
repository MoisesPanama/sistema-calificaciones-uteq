...
psql -U postgres -d calificaciones_uteq -f database/34_familia.sql
```
...
| POST | `/api/preinscripciones/:id/aprobar` | Aprueba con bloqueo de cupo (nuevo o rematrícula por nivel; crea login del acudiente) |
